...
fun VeterinariosScreen(viewModel: MainViewModel, navController: NavController) {
    ...
    Scaffold(
        ...
        LazyColumn(
            ...
            item {
                Text("Gestión de Veterinarios", style = MaterialTheme.typography.headlineMedium, modifier = Modifier.padding(vertical = 16.dp))
            }
    ...
    Card(
        ...
        Row(
            ...
            Column(modifier = Modifier.weight(1f)) {
                Text(veterinario.nombre, style = MaterialTheme.typography.titleMedium, fontWeight = FontWeight.Bold)
                Text(veterinario.especialidad, style = MaterialTheme.typography.bodySmall)
            }
            Row {
